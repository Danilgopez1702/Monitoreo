...
$delete = mysqli_query($conexion, "DELETE FROM `ip`");
                              ...
                              //Ciclo para extraer del array
                                    foreach ($ARRAY as $y) {
                                          ...
                                          //Extraccion de datos del array
                                                ...
                                                $ether = "ether";
                                                $eoip_vlan = "eoip-vlan";
                                                $cadena = utf8_encode($type);
                                          //Subida a bd
                                                      if(stristr($type, 'eoip-vlan')){
                                                            $sql_temp = mysqli_query($conexion, "INSERT INTO `ip`(`ip_mk`, `nombre`,`ip`,`network`,`interface`,`tipo`) 
                                                                  VALUES ('$ip_mk','$cadena','$ip','$network','$type','$eoip_vlan')");
                                                      }else if(stristr($type, 'LoopBack')){
                                                            $sql_temp = mysqli_query($conexion, "INSERT INTO `ip`(`ip_mk`, `nombre`,`ip`,`network`,`interface`,`tipo`) 
                                                                  VALUES ('$ip_mk','$cadena','$ip','$network','$type','$LoopBack')");
                                                      }else if(stristr($type, 'sfp')){
                                                            $sql_temp = mysqli_query($conexion, "INSERT INTO `ip`(`ip_mk`, `nombre`,`ip`,`network`,`interface`,`tipo`) 
                                                                  VALUES ('$ip_mk','$cadena','$ip','$network','$type','$sfp')");
                                                      }else if(stristr($type, 'ether')){
                                                            $sql_temp = mysqli_query($conexion, "INSERT INTO `ip`(`ip_mk`, `nombre`,`ip`,`network`,`interface`,`tipo`) 
                                                                  VALUES ('$ip_mk','$cadena','$ip','$network','$type','$ether')");
                                                                                     
                                                      }else if(stristr($type, 'vlan')){
                                                            $sql_temp = mysqli_query($conexion, "INSERT INTO `ip`(`ip_mk`, `nombre`,`ip`,`network`,`interface`,`tipo`) 
                                                                  VALUES ('$ip_mk','$cadena','$ip','$network','$type','$vlan')");
      
                                                      }else if(stristr($type, 'eoip')){
                                                            $sql_temp = mysqli_query($conexion, "INSERT INTO `ip`(`ip_mk`, `nombre`,`ip`,`network`,`interface`,`tipo`) 
                                                                  VALUES ('$ip_mk','$cadena','$ip','$network','$type','$eoip')");
                                                      }                             
                                    }
                        }
