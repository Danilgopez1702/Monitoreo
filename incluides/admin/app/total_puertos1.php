...
$salida = "";
$sql = "SELECT * FROM puerto ORDER BY velocidad DESC";
        ...
        <div class="card-header" style="background: #4BB545;">
            <font color="white">
                ...
                <div class="text-start">
                  ...
                  <h6 class="card-text">MK: '. $fila['nombre_mk'].'</h6>
                  <h6 class="card-text">Puerto: '. $fila['puerto'].'</h6>
                  <h6 class="card-text">Velocidad: '. $fila['velocidad'].'</h6>
