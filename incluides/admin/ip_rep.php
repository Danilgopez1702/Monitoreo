...
?>
    ...
    <div class="align-middle ">
        ...
        <h3 class="card-title">Ip Repetidas</h3></div>
        <br>
            <div class="table-responsive">
                <a href="rep.php" type="button" class="btn bg-gradient-primary" ><span class="glyphicon glyphicon-plus"></span> Actualizar</a>
                <div id="datos">
...
<script src="js/buscar_ip_rep.js"></script>