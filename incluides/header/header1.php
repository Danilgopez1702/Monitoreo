    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
      ...
      <div class="" id="sidenav-collapse-main">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
            <a id= "segundo" class="nav-link text-white " href="./ruta_fibra.php">
                <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                  <i class="material-icons opacity-10">router</i>
                </div>
                <span class="nav-link-text ms-1">Agregar Ruta de Fibra</span>
            </a>
          </li> 
          <li class="nav-item">
            <a id= "segundo" class="nav-link text-white " href="./ruta_torre.php">
                <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                  <i class="material-icons opacity-10">router</i>
                </div>
                <span class="nav-link-text ms-1">Agregar Ruta Torre</span>
            </a>
          </li>     
          <li class="nav-item">
            <a id= "segundo" class="nav-link text-white " href="./nueva_vlan.php">
                <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                  <i class="material-icons opacity-10">router</i>
                </div>
                <span class="nav-link-text ms-1">Agregar Vlan</span>
            </a>
          </li>  
          <li class="nav-item">
            <a id= "segundo" class="nav-link text-white " href="./reinicio.php">
                <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                  <i class="material-icons opacity-10">refresh</i>
                </div>
                <span class="nav-link-text ms-1">Reiniciar Mikrotik</span>
            </a>
          </li>
          <li class="nav-item">
